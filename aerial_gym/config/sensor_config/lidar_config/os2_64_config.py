...
# 定义一个名为OS_2_64_Config的类，继承自OS_0_128_Config类
class OS_2_64_Config(OS_0_128_Config):
    ...
    vertical_fov_deg_min = -11.25   # 垂直视场角最小值
    vertical_fov_deg_max = +11.25    # 垂直视场角最大值

    # 设置激光雷达的最大探测范围和最小探测范围（单位：米）
    max_range = 200.0               # 最大探测距离
    min_range = 0.7                 # 最小探测距离
